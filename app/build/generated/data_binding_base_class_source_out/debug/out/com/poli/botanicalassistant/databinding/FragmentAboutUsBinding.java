...
public final class FragmentAboutUsBinding implements ViewBinding {
  ...
  @NonNull
  public final RecyclerView aboutUsRecycler;

  private FragmentAboutUsBinding(@NonNull ConstraintLayout rootView,
      @NonNull RecyclerView aboutUsRecycler) {
    this.rootView = rootView;
    this.aboutUsRecycler = aboutUsRecycler;
  }
  ...
  public static FragmentAboutUsBinding bind(@NonNull View rootView) {
    ...
    int id;
    missingId: {
      id = R.id.about_us_recycler;
      RecyclerView aboutUsRecycler = ViewBindings.findChildViewById(rootView, id);
      if (aboutUsRecycler == null) {
        break missingId;
      }

      return new FragmentAboutUsBinding((ConstraintLayout) rootView, aboutUsRecycler);
    }
